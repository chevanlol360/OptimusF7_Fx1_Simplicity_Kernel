...
static struct acpu_level acpu_freq_tbl_slow[] __initdata = {
	{ 1, {   167000, HFPLL, 2, 0x04 }, L2(0),   900000 },
 	{ 1, {   216000, HFPLL, 2, 0x08 }, L2(0),   900000 },
 	{ 1, {   270000, HFPLL, 2, 0x0A }, L2(0),   900000 },
 	{ 1, {   316000, HFPLL, 2, 0x0C }, L2(0),   900000 },
	{ 1, {   384000, PLL_8, 0, 0x00 }, L2(0),   925000, AVS(0x40001F) },
	{ 1, {   432000, HFPLL, 2, 0x20 }, L2(6),   925000 },
	{ 1, {   486000, HFPLL, 2, 0x24 }, L2(6),   950000 },
	{ 1, {   540000, HFPLL, 2, 0x28 }, L2(6),   975000 },
	{ 1, {   594000, HFPLL, 1, 0x16 }, L2(6),   975000 },
	{ 1, {   648000, HFPLL, 1, 0x18 }, L2(6),  1000000 },
	{ 1, {   702000, HFPLL, 1, 0x1A }, L2(6),  1000000 },
	{ 1, {   756000, HFPLL, 1, 0x1C }, L2(6),  1025000 },
	{ 1, {   810000, HFPLL, 1, 0x1E }, L2(6),  1025000 },
	{ 1, {   864000, HFPLL, 1, 0x20 }, L2(6),  1075000 },
	{ 1, {   918000, HFPLL, 1, 0x22 }, L2(6),  1075000 },
	{ 1, {   972000, HFPLL, 1, 0x24 }, L2(6),  1100000 },
	{ 1, {  1026000, HFPLL, 1, 0x26 }, L2(6),  1100000 },
	...
	{ 1, {  1404000, HFPLL, 1, 0x34 }, L2(18), 1200000, AVS(0x400015) },
...
static struct acpu_level acpu_freq_tbl_nom[] __initdata = {
	{ 1, {   167000, HFPLL, 2, 0x04 }, L2(0),   825000 },
 	{ 1, {   216000, HFPLL, 2, 0x08 }, L2(0),   825000 },
 	{ 1, {   270000, HFPLL, 2, 0x0A }, L2(0),   850000 },
 	{ 1, {   316000, HFPLL, 2, 0x0C }, L2(0),   850000 },
	{ 1, {   384000, PLL_8, 0, 0x00 }, L2(0),   850000, AVS(0x40007F) },
	...
	{ 1, {   756000, HFPLL, 1, 0x1C }, L2(6),   925000 },
	{ 1, {   810000, HFPLL, 1, 0x1E }, L2(6),   950000 },
	{ 1, {   864000, HFPLL, 1, 0x20 }, L2(6),   950000 },
	{ 1, {   918000, HFPLL, 1, 0x22 }, L2(6),   975000 },
	{ 1, {   972000, HFPLL, 1, 0x24 }, L2(6),  1000000 },
	{ 1, {  1026000, HFPLL, 1, 0x26 }, L2(6),  1000000 },
	{ 1, {  1080000, HFPLL, 1, 0x28 }, L2(18), 1025000, AVS(0x400015) },
	{ 1, {  1134000, HFPLL, 1, 0x2A }, L2(18), 1025000, AVS(0x400015) },
	{ 1, {  1188000, HFPLL, 1, 0x2C }, L2(18), 1075000, AVS(0x400015) },
	{ 1, {  1242000, HFPLL, 1, 0x2E }, L2(18), 1075000, AVS(0x400015) },
	{ 1, {  1296000, HFPLL, 1, 0x30 }, L2(18), 1100000, AVS(0x400015) },
	{ 1, {  1350000, HFPLL, 1, 0x32 }, L2(18), 1100000, AVS(0x400015) },
	{ 1, {  1404000, HFPLL, 1, 0x34 }, L2(18), 1125000, AVS(0x400015) },
	{ 1, {  1458000, HFPLL, 1, 0x36 }, L2(18), 1125000, AVS(0x100018) },
	...
	{ 1, {  1674000, HFPLL, 1, 0x3E }, L2(19), 1175000 },
	{ 1, {  1728000, HFPLL, 1, 0x40 }, L2(19), 1200000 },
	{ 0, { 0 } }
};

static struct acpu_level acpu_freq_tbl_fast[] __initdata = {
	{ 1, {   167000, HFPLL, 2, 0x04 }, L2(0),   800000 },
 	{ 1, {   216000, HFPLL, 2, 0x08 }, L2(0),   800000 },
 	{ 1, {   270000, HFPLL, 2, 0x0A }, L2(0),   800000 },
 	{ 1, {   316000, HFPLL, 2, 0x0C }, L2(0),   800000 },
	{ 1, {   384000, PLL_8, 0, 0x00 }, L2(0),   825000, AVS(0x4000FF) },
	{ 1, {   432000, HFPLL, 2, 0x20 }, L2(6),   825000 },
	{ 1, {   486000, HFPLL, 2, 0x24 }, L2(6),   850000 },
	{ 1, {   540000, HFPLL, 2, 0x28 }, L2(6),   850000 },
	{ 1, {   594000, HFPLL, 1, 0x16 }, L2(6),   900000 },
	{ 1, {   648000, HFPLL, 1, 0x18 }, L2(6),   900000 },
	{ 1, {   702000, HFPLL, 1, 0x1A }, L2(6),   925000 },
	{ 1, {   756000, HFPLL, 1, 0x1C }, L2(6),   925000 },
	...
	{ 1, {   864000, HFPLL, 1, 0x20 }, L2(6),   950000 },
	{ 1, {   918000, HFPLL, 1, 0x22 }, L2(6),   975000 },
	{ 1, {   972000, HFPLL, 1, 0x24 }, L2(6),   975000 },
	{ 1, {  1026000, HFPLL, 1, 0x26 }, L2(6),  1000000 },
	{ 1, {  1080000, HFPLL, 1, 0x28 }, L2(18), 1000000, AVS(0x10001B) },
	{ 1, {  1134000, HFPLL, 1, 0x2A }, L2(18), 1025000, AVS(0x10001B) },
	{ 1, {  1188000, HFPLL, 1, 0x2C }, L2(18), 1025000, AVS(0x10001B) },
	{ 1, {  1242000, HFPLL, 1, 0x2E }, L2(18), 1050000, AVS(0x10001B) },
	{ 1, {  1296000, HFPLL, 1, 0x30 }, L2(18), 1050000, AVS(0x10001B) },
	{ 1, {  1350000, HFPLL, 1, 0x32 }, L2(18), 1075000, AVS(0x400012) },
	{ 1, {  1404000, HFPLL, 1, 0x34 }, L2(18), 1075000, AVS(0x400012) },
	{ 1, {  1458000, HFPLL, 1, 0x36 }, L2(18), 1100000, AVS(0x400012) },
	{ 1, {  1512000, HFPLL, 1, 0x38 }, L2(18), 1100000, AVS(0x400012) },
	{ 1, {  1566000, HFPLL, 1, 0x3A }, L2(18), 1125000 },
	{ 1, {  1620000, HFPLL, 1, 0x3C }, L2(18), 1125000 },
	{ 1, {  1674000, HFPLL, 1, 0x3E }, L2(19), 1150000 },
	{ 1, {  1728000, HFPLL, 1, 0x40 }, L2(19), 1150000 },
	{ 0, { 0 } }
};
#ifdef CONFIG_MACH_LGE
